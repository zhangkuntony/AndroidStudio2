...
public class CalculatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_result.setMovementMethod(new ScrollingMovementMethod());             //  设置tv_result内部文本的移动方式为滚动形式
        //  下面给每个按钮控件都注册了点击监听器
    ...
    public void onClick(View v) {
        ...
        if (resid == R.id.btn_clear) {                                          //  点击了清除按钮
            ...
            if (operator.equals("=") || operator.equals("√")) {                 //  上一次点击了等号或开根号按钮，则清空操作符
                operator = "";
                firstNum = "";
                showText = "";
            }
    ...
    private boolean calculate() {
        ...
        Log.d(TAG, "result = " + result);                                   //  把运算结果打印到日志中
        firstNum = result;
        nextNum = "";
