...
public class ClickActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_click = findViewById(R.id.btn_click);            //  从布局文件中获取名叫btn_click的按钮控件
        btn_click.setOnClickListener(new MyOnClickListener());      //  给btn_click设置点击监听器，一旦用户点击按钮，就触发监听器的onClick方法
        btn_click.setOnLongClickListener(new MyOnLongClickListener());//  给btn_click设置长按监听器，一旦用户长按按钮，就触发监听器的onLongClick方法
    }
