...
public class CheckboxActivity extends AppCompatActivity implements OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox ck_custom = findViewById(R.id.ck_custom);                      //  从布局文件中获取名叫ck_custom的复选框
        ck_system.setOnCheckedChangeListener(this);                             //  给ck_system设置勾选监听器，一旦用户点击复选框，就触发监听器的onCheckedChanged方法
        ck_custom.setOnCheckedChangeListener(this);                             //  给ck_custom设置勾选监听器，一旦用户点击复选框，就触发监听器的onCheckedChanged方法
    }
